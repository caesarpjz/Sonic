...
DROP FUNCTION IF EXISTS addPromotionForManagers(DATE, DATE, VARCHAR, INTEGER, BOOLEAN) CASCADE;
...
DROP FUNCTION IF EXISTS addRestaurantPromotion(DATE, DATE, TEXT, FLOAT, INTEGER, BOOLEAN) CASCADE;
